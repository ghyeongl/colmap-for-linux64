...
if(NOT EXISTS "/home/ghryu/Drives/Env-AI/gaussian-splatting/colmap/build/_deps/poselib-build/install_manifest.txt")
  message(FATAL_ERROR "Cannot find install manifest: /home/ghryu/Drives/Env-AI/gaussian-splatting/colmap/build/_deps/poselib-build/install_manifest.txt")
endif()

# remove files from 'install_manifest.txt'
message(STATUS "")
message(STATUS "Removing files from 'install_manifest.txt'")
file(READ "/home/ghryu/Drives/Env-AI/gaussian-splatting/colmap/build/_deps/poselib-build/install_manifest.txt" files)
